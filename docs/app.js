...
window.onload = function () {
    // Load the rows of FreeCAD Github project data from the JSON file.
    // fetch('/freecad_repos.json')
    fetch('https://devbisme.github.io/freecad_project_explorer/freecad_repos.json')
